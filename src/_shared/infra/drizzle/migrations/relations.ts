...
import { user, anomaliaProdutividade, demanda, configuracaoImpressaoMapa, center, corteMercadoria, transporte, palete, configuracao, historicoImpressaoMapa, pausa, pausaGeral, dashboardProdutividadeUser, dashboardProdutividadeCenter, devolucaoDemanda, devolucaoHistoricoStatus, devolucaoNotas, devolucaoItens, devolucaoAnomalias, devolucaoTransportadoras, devolucaoCheckList, devolucaImagens, rulesEngines, historicoStatusTransporte, userCenter } from "./schema";

export const anomaliaProdutividadeRelations = relations(anomaliaProdutividade, ({one}) => ({
...
export const configuracaoImpressaoMapaRelations = relations(configuracaoImpressaoMapa, ({one}) => ({
	user: one(user, {
...
export const corteMercadoriaRelations = relations(corteMercadoria, ({one}) => ({
	center: one(center, {
...
export const historicoImpressaoMapaRelations = relations(historicoImpressaoMapa, ({one}) => ({
	user: one(user, {
...
export const dashboardProdutividadeUserRelations = relations(dashboardProdutividadeUser, ({one}) => ({
	center: one(center, {
...
export const dashboardProdutividadeCenterRelations = relations(dashboardProdutividadeCenter, ({one}) => ({
	center: one(center, {
...
export const devolucaoDemandaRelations = relations(devolucaoDemanda, ({one, many}) => ({
	center: one(center, {
...
export const devolucaoAnomaliasRelations = relations(devolucaoAnomalias, ({one}) => ({
	devolucaoDemanda: one(devolucaoDemanda, {
...
export const devolucaoTransportadorasRelations = relations(devolucaoTransportadoras, ({one}) => ({
	center: one(center, {
...
export const devolucaoCheckListRelations = relations(devolucaoCheckList, ({one}) => ({
	devolucaoDemanda: one(devolucaoDemanda, {
...
export const devolucaImagensRelations = relations(devolucaImagens, ({one}) => ({
	devolucaoDemanda: one(devolucaoDemanda, {
...
export const historicoStatusTransporteRelations = relations(historicoStatusTransporte, ({one}) => ({
	user: one(user, {
