...
CREATE TYPE "public"."Turno" AS ENUM('MANHA', 'TARDE', 'NOITE', 'INTERMEDIARIO');--> statement-breakpoint
CREATE TABLE "imagem" (
...
CREATE TABLE "CorteMercadoria" (
	...
	"caixas" integer NOT NULL,
	"direcao" "DirecaoCorte" DEFAULT 'OPERACIONAL' NOT NULL,
	"unidades" integer NOT NULL,
	"centerId" text NOT NULL,
	"descricao" text,
	"realizadoPorId" text
...
CREATE UNIQUE INDEX "rules_engines_name_centerId_key" ON "rules_engines" USING btree ("name" text_ops,"centerId" text_ops);
*/